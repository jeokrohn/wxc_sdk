...
__all__ = ['Api', 'AttendeePrivileges', 'AudioConnectionOptions', 'AudioConnectionType', 'BreakoutSessionObject',
           'CallInNumbers', 'Condition', 'CreateMeetingResponse', 'CustomizedQuestionForCreateMeeting',
           'EntryAndExitTone', 'GetMeetingSurveyResponse', 'InputMode',
           'InterpreterObjectForSimultaneousInterpretationOfCreateOrUpdateMeeting',
           'InterpreterObjectForSimultaneousInterpretationOfGetOrListMeeting', 'InviteeObjectForCreateMeeting',
           'JoinMeetingResponse', 'Links', 'ListMeetingSurveyResultsResponse', 'ListMeetingTrackingCodesResponse',
           'ListMeetingsOfMeetingSeriesResponse', 'ListMeetingsResponse', 'MeetingOptions',
           'MeetingSeriesObjectForListMeeting', 'MeetingType', 'NoteType', 'Options', 'OptionsForTrackingCodeObject',
           'PatchMeetingBody', 'PatchMeetingResponse', 'Question', 'QuestionAnswerObject', 'QuestionObject',
           'QuestionWithAnswersObject', 'Registration', 'Registration1', 'Result', 'Rules', 'ScheduledMeetingObject',
           'ScheduledType', 'Service', 'SimultaneousInterpretation', 'SimultaneousInterpretation1',
           'StandardRegistrationApproveRule', 'State', 'SurveyResultObject', 'Telephony', 'Telephony3',
           'TrackingCodeItemForCreateMeetingObject', 'Type', 'Type3', 'Type5', 'UnlockedMeetingJoinSecurity']
...
class QuestionAnswerObject(ApiModel):
...
class QuestionWithAnswersObject(ApiModel):
    ...
    type: Optional[Type3]
    #: The user's answers for the question.
    answers: Optional[list[QuestionAnswerObject]]
...
class Api(ApiChild, base='meetings'):
    ...
    def join(self, meeting_id: str = None, meeting_number: str = None, web_link: str = None, join_directly: bool = None, email: str = None, display_name: str = None, password: str = None, expiration_minutes: int = None) -> JoinMeetingResponse:
        """
