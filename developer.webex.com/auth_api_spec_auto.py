...
class PostCallQueueCallPolicyObject1(PostCallQueueCallPolicyObject):
...
class CallQueueQueueSettingsObject3(CallQueueQueueSettingsObject):
...
class GetCallQueueCallPolicyObject1(PostCallQueueCallPolicyObject):
    #: Call routing type to use to dispatch calls to agents.
    routing_type: Optional[HuntRoutingTypeSelection]


class CallQueueQueueSettingsObject4(CallQueueQueueSettingsObject):
    #: Play a message when callers first reach the queue. For example, “Thank you for calling. An agent will be with you shortly.” It can be set as mandatory. If the mandatory option is not selected and a caller reaches the call queue while there is an available agent, the caller will not hear this announcement and is transferred to an agent. By default, it is enabled with default configurations.
    welcome_message: Optional[WelcomeMessage]
    #: Notify the caller with either their estimated wait time or position in the queue. If this option is enabled, it plays after the welcome message and before the comfort message. By default, it is not enabled.
    wait_message: Optional[WaitMessage]
...
class GetPersonPlaceCallQueueObject(PostPersonPlaceObject):
    #: First name of person or workspace.
    first_name: Optional[str]
    #: First name of person or workspace.
    last_name: Optional[str]
    ...
    #: Extension of person or workspace.
    extension: Optional[str]
    #: Skill level of person or workspace. Only applied when the call routingType is SKILL_BASED.
    skill_level: Optional[int]
...
class ModifyCallQueueCallPolicyObject1(PostCallQueueCallPolicyObject):
    #: Call routing type to use to dispatch calls to agents.
    routing_type: Optional[HuntRoutingTypeSelection]


class CallQueueQueueSettingsObject5(CallQueueQueueSettingsObject):
    #: Play a message when callers first reach the queue. For example, “Thank you for calling. An agent will be with you shortly.” It can be set as mandatory. If the mandatory option is not selected and a caller reaches the call queue while there is an available agent, the caller will not hear this announcement and is transferred to an agent. By default, it is enabled with default configurations.
    welcome_message: Optional[WelcomeMessage]
    #: Notify the caller with either their estimated wait time or position in the queue. If this option is enabled, it plays after the welcome message and before the comfort message. By default, it is not enabled.
    wait_message: Optional[WaitMessage]
...
class ModifyPersonPlaceCallQueueObject(PostPersonPlaceObject):
    #: Skill level of person or workspace. Only applied when call routing type is SKILL_BASED.
    skill_level: Optional[int]
...
class CreateCallQueueBody1(GetDetailsForCallParkExtensionResponse):
    ...
    time_zone: Optional[str]
    #: Policy controlling how calls are routed to agents.
    call_policies: Optional[PostCallQueueCallPolicyObject1]
    #: Overall call queue settings.
    queue_settings: Optional[CallQueueQueueSettingsObject3]
    #: People, including workspaces, that are eligible to receive calls.
...
class CreateCallQueueResponse1(ApiModel):
    #: ID of the newly created call queue.
    id: Optional[str]


class GetDetailsForCallQueueResponse1(CallForwardRulesModifyObject):
    #: Unique name for the call queue.
    name: Optional[str]
    #: Language for the call queue.
    language: Optional[str]
    ...
    time_zone: Optional[str]
    #: Policy controlling how calls are routed to agents.
    call_policies: Optional[GetCallQueueCallPolicyObject1]
    #: Overall call queue settings.
    queue_settings: Optional[CallQueueQueueSettingsObject4]
    #: Flag to indicate whether call waiting is enabled for agents.
    allow_call_waiting_for_agents_enabled: Optional[bool]
    #: People, including workspaces, that are eligible to receive calls.
...
class UpdateCallQueueBody1(GetDetailsForCallParkExtensionResponse):
    #: Whether or not the call queue is enabled.
    enabled: Optional[bool]
    #: Language code.
    language_code: Optional[str]
    ...
    alternate_number_settings: Optional[AlternateNumberSettings]
    #: Policy controlling how calls are routed to agents.
    call_policies: Optional[ModifyCallQueueCallPolicyObject1]
    #: Overall call queue settings.
    queue_settings: Optional[CallQueueQueueSettingsObject5]
    #: Flag to indicate whether call waiting is enabled for agents.
    allow_call_waiting_for_agents_enabled: Optional[bool]
    #: People, including workspaces, that are eligible to receive calls.
...
class ReadListOfCallQueueAnnouncementFilesResponse1(ApiModel):
    #: Array of announcements for this call queue.
    announcements: Optional[list[GetAnnouncementFileInfo]]
...
class WebexCallingOrganizationSettingsWithAgentJoinUnjoinAndAnnouncementFeaturesApi(ApiChild, base='telephony/config/locations/{locationId}/queues'):
    ...
    def create_queue(self, location_id: str, org_id: str = None, name: str, call_policies: PostCallQueueCallPolicyObject, queue_settings: CallQueueQueueSettingsObject, agents: List[PostPersonPlaceCallQueueObject], phone_number: str = None, extension: str = None, language_code: str = None, first_name: str = None, last_name: str = None, time_zone: str = None, allow_agent_join_enabled: bool = None) -> str:
        """
        Create new Call Queues for the given location.
        Call queues temporarily hold calls in the cloud when all agents, which
        can be users or agents, assigned to receive calls from the queue are
    ...
    def details_for_queue(self, location_id: str, queue_id: str, org_id: str = None) -> GetDetailsForCallQueueResponse1:
        """
        Retrieve Call Queue details.
        Call queues temporarily hold calls in the cloud when all agents, which
        can be users or agents, assigned to receive calls from the queue are
        ...
        url = self.ep(f'{queue_id}')
        data = super().get(url=url, params=params)
        return GetDetailsForCallQueueResponse1.parse_obj(data)

    def update_queue(self, location_id: str, queue_id: str, org_id: str = None, queue_settings: CallQueueQueueSettingsObject, enabled: bool = None, name: str = None, language_code: str = None, first_name: str = None, last_name: str = None, time_zone: str = None, phone_number: str = None, extension: str = None, alternate_number_settings: object = None, call_policies: PostCallQueueCallPolicyObject = None, allow_call_waiting_for_agents_enabled: bool = None, agents: List[ModifyPersonPlaceCallQueueObject] = None, allow_agent_join_enabled: bool = None):
        """
        Update the designated Call Queue.
        Call queues temporarily hold calls in the cloud when all agents, which
        can be users or agents, assigned to receive calls from the queue are
...
class RetrieveCallForwardingSettingsForWorkspaceResponse1(ApiModel):
    #: CallForward Setting for a Workspace.
    call_forwarding: Optional[CallForwardingPlaceSettingGet]
...
class RetrieveAuthorizationCodesForWorkspaceResponse(ApiModel):
    #: Indicates set of activation codes and description.
    authorization_codes: Optional[list[AccessCodes]]


class ModifyAuthorizationCodesForWorkspaceBody(ApiModel):
    #: Indicates authorization codes to delete.
    delete_codes: Optional[list[str]]


class WebexCallingWorkspacesSettingsApi(ApiChild, base='workspaces/{workspaceId}/features/'):
    """
    ...
    def retrieve_callwarding_settings_workspace(self, workspace_id: str, org_id: str = None) -> CallForwardingPlaceSettingGet:
        ...
        :param workspace_id: Unique identifier for the workspace.
        :type workspace_id: str
        :param org_id: Workspace is in this organization. Only admin users of another organization (such as partners) may use this parameter as the default is the same organization as the token used to access API.
        :type org_id: str
        """
        params = {}
        if org_id is not None:
    ...
    def modify_callwarding_settings_workspace(self, workspace_id: str, org_id: str = None, call_forwarding: CallForwardingPlaceSettingPatch):
        """
        Modify CallForwardSettings for a Workspace.
        Two types of call forwarding are supported:
        This API requires a full or user administrator auth token with the spark-admin:workspaces_write scope or a user auth token with spark:workspaces_write scope can be used to update workspace settings.
        ...
        :param org_id: Workspace is in this organization. Only admin users of another organization (such as partners) may use this parameter as the default is the same organization as the token used to access API.
        :type org_id: str
        :param call_forwarding: CallForward Setting for a Workspace.
        :type call_forwarding: CallForwardingPlaceSettingPatch
        """
        params = {}
        if org_id is not None:
...
Possible values: DIRECT_LINE
    ...
    def retrieve_authorization_codes_workspace(self, workspace_id: str, org_id: str = None) -> List[AccessCodes]:
        """
        ...
        if org_id is not None:
            params['orgId'] = org_id
        url = self.ep(f'outgoingPermission/authorizationCodes')
        data = super().get(url=url, params=params)
        return data["authorizationCodes"]

    def modify_authorization_codes_workspace(self, workspace_id: str, org_id: str = None, delete_codes: List[str] = None):
        """
        ...
        :param org_id: Workspace is in this organization. Only admin users of another organization (such as partners) may use this parameter as the default is the same organization as the token used to access API.
        :type org_id: str
        :param delete_codes: Indicates authorization codes to delete.
        :type delete_codes: List[str]
        """
        params = {}
        if org_id is not None:
    ...
    def create_authorization_codes_workspace(self, workspace_id: str, org_id: str = None, code: str, description: str):
        """
        Create new Authorization codes for the given workspace.
        Authorization codes are used to bypass permissions.
        This API requires a full or user administrator auth token with the spark-admin:workspaces_write scope or a user auth token with spark:workspaces_write scope can be used to update workspace settings.
