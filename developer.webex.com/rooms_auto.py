...
class RoomsApi(ApiChild, base='rooms'):
    ...
    def list(self, team_id: str = None, type_: str = None, sort_by: str = None, **params) -> Generator[Room, None, None]:
        ...
        :type team_id: str
        :param type_: str: List rooms by type.
...
Possible values: id, lastactivity, created
    ...
    def update(self, room_id: str, title: str, classification_id: str = None, team_id: str = None, is_locked: bool = None, is_announcement_only: bool = None, is_read_only: bool = None) -> Room:
        ...
        :param classification_id: str: The classificationId for the room.
        :type classification_id: str
        :param team_id: str: The teamId to which this space should be assigned. Only unowned spaces can be assigned to a team. Assignment between teams is unsupported.
        :type team_id: str
        :param is_locked: bool: Set the space as locked/moderated and the creator becomes a moderator
        :type is_locked: bool
        :param is_announcement_only: bool: Sets the space into Announcement Mode or clears the Anouncement Mode (false)
        :type is_announcement_only: bool
        :param is_read_only: bool: A compliance officer can set a direct room as read-only, which will disallow any new information exchanges in this space, while maintaing historical data.
