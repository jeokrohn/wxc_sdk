...
class UpdateMeetingBody(ApiModel):
    ...
    #: Whether or not auto-mute attendees when attendees enter meetings
...
class CreateMeetingResponse(ApiModel):
...
class CreateMeetingBody(UpdateMeetingBody):
...
class UpdateMeetingResponse(MeetingSeriesObjectForListMeeting):
    #: Whether or not breakout sessions are enabled.
    enabled_breakout_sessions: Optional[bool]
    #: HATEOAS Breakout Sessions information for meeting.
    links: Optional[list[Links]]
...
class MeetingsApi(ApiChild, base='meetings'):
    ...
    def create(self, title: str, password: str, start: str, end: str, enabled_breakout_sessions: bool, agenda: str = None, timezone: str = None, recurrence: str = None, enabled_auto_record_meeting: bool = None, allow_any_user_to_be_co_host: bool = None, enabled_join_before_host: bool = None, enable_connect_audio_before_host: bool = None, join_before_host_minutes: int = None, exclude_password: bool = None, public_meeting: bool = None, reminder_time: int = None, unlocked_meeting_join_security: UnlockedMeetingJoinSecurity = None, session_type_id: int = None, enabled_webcast_view: bool = None, panelist_password: str = None, enable_automatic_lock: bool = None, automatic_lock_minutes: int = None, allow_first_user_to_be_co_host: bool = None, allow_authenticated_devices: bool = None, send_email: bool = None, host_email: str = None, site_url: str = None, meeting_options: MeetingOptions = None, attendee_privileges: AttendeePrivileges = None, integration_tags: List[str] = None, tracking_codes: TrackingCodeItemForCreateMeetingObject = None, allow_attendee_to_unmute_self: bool = None, mute_attendee_upon_entry: bool = None, allow_host_to_unmute_participants: bool = None, adhoc: bool = None, room_id: str = None, template_id: str = None, scheduled_type: ScheduledType = None, invitees: InviteeObjectForCreateMeeting = None, registration: Registration = None, simultaneous_interpretation: SimultaneousInterpretation = None, breakout_sessions: BreakoutSessionObject = None) -> CreateMeetingResponse:
        ...
        :param allow_attendee_to_unmute_self: Whether or not to allow attendees to unmute themselves
        :type allow_attendee_to_unmute_self: bool
        :param mute_attendee_upon_entry: Whether or not auto-mute attendees when attendees enter meetings
        :type mute_attendee_upon_entry: bool
...
Possible values: meeting, webinar, personalRoomMeeting
        ...
        :param participant_email: Meeting participant email address for the meeting objects being requested. This parameter only applies when meetingType is meeting, and it will be ignored if meetingNumber, webLink or roomId is specified.
        :type participant_email: str
        ...
        if participant_email is not None:
            params['participantEmail'] = participant_email
        if current is not None:
            params['current'] = current
        if from_ is not None:
            params['from'] = from_
...
Possible values: scheduled, ready, lobby, inProgress, ended, missed
    ...
    def update(self, meeting_id: str, title: str, password: str, start: str, end: str, enabled_breakout_sessions: bool, agenda: str = None, timezone: str = None, recurrence: str = None, enabled_auto_record_meeting: bool = None, allow_any_user_to_be_co_host: bool = None, enabled_join_before_host: bool = None, enable_connect_audio_before_host: bool = None, join_before_host_minutes: int = None, exclude_password: bool = None, public_meeting: bool = None, reminder_time: int = None, unlocked_meeting_join_security: UnlockedMeetingJoinSecurity = None, session_type_id: int = None, enabled_webcast_view: bool = None, panelist_password: str = None, enable_automatic_lock: bool = None, automatic_lock_minutes: int = None, allow_first_user_to_be_co_host: bool = None, allow_authenticated_devices: bool = None, send_email: bool = None, host_email: str = None, site_url: str = None, meeting_options: MeetingOptions = None, attendee_privileges: AttendeePrivileges = None, integration_tags: List[str] = None, tracking_codes: TrackingCodeItemForCreateMeetingObject = None, allow_attendee_to_unmute_self: bool = None, mute_attendee_upon_entry: bool = None, allow_host_to_unmute_participants: bool = None) -> UpdateMeetingResponse:
        """
    ...
    def join(self, email: str = None, display_name: str = None, meeting_id: str = None, meeting_number: str = None, web_link: str = None, join_directly: bool = None, password: str = None) -> JoinMeetingResponse:
        """
