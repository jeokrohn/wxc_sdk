...
class ReportsApi(ApiChild, base='reports'):
    ...
    def list_reports(self, report_id: str = None, service: str = None, template_id: int = None, from_: Union[str,
                     datetime] = None, to_: Union[str, datetime] = None) -> builtins.list[Report]:
        """
        List Reports
    ...
    def createa_report(self, template_id: int, start_date: Union[str, datetime] = None, end_date: Union[str,
                       datetime] = None, site_list: str = None, time_zone: str = None) -> str:
        """
        Create a Report
    ...
    def delete_areport(self, report_id: str) -> None:
        """
        Delete a Report
