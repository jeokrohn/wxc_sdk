...
__all__ = ['Room', 'RoomMeetingDetails', 'RoomType', 'RoomsApi', 'SortBy']
...
class RoomsApi(ApiChild, base='rooms'):
    ...
    def list_rooms(self, team_id: str = None, type: RoomType = None, org_public_spaces: bool = None, from_: Union[str,
                   datetime] = None, to_: Union[str, datetime] = None, sort_by: SortBy = None,
                   **params: Any) -> Generator[Room, None, None]:
        """
        List Rooms
    ...
    def delete_a_room(self, room_id: str) -> None:
        """
        Delete a Room
    ...
    def update_a_room(self, room_id: str, title: str, classification_id: str = None, team_id: str = None,
        ...
        <div><Callout type="info">A Compliance Officer who is not a member of a space can only update the
        `classificationId`, `isAnnouncementOnly`, `description`, and `isPublic` fields.
        </Callout></div>
