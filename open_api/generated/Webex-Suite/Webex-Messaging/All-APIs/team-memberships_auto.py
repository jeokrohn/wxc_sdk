...
class TeamMembershipsApi(ApiChild, base='team/memberships'):
    ...
    def list_team_memberships(self, team_id: str, **params: Any) -> Generator[TeamMembership, None, None]:
        """
    ...
    def create_team_membership(self, team_id: str, person_id: str = None, person_email: str = None,
    ...
    def delete_a_team_membership(self, membership_id: str) -> None:
        """
