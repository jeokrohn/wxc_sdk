...
__all__ = ['BetaFeaturesVirtualExtensionsApi', 'GetVirtualExtensionObject', 'GetVirtualExtensionObjectLevel',
           'GetVirtualExtensionRangeDetailsObject', 'GetVirtualExtensionRangeListObject',
           'GetVirtualExtensionRangeListObjectLevel', 'GetVirtualExtensionSettingsObjectMode',
           'PutVirtualExtensionRangeObjectAction', 'ValidateVirtualExtensionRangeResponseObject',
           'ValidateVirtualExtensionRangeResponseObjectStatus', 'VirtualExtensionRangeValidationStatusEnum',
           'VirtualExtensionRangeValidationStatusObject']
...
class GetVirtualExtensionSettingsObjectMode(str, Enum):
    standard = 'STANDARD'


class GetVirtualExtensionRangeDetailsObject(ApiModel):
...
class GetVirtualExtensionRangeListObjectLevel(str, Enum):
    #: Organization level.
...
class GetVirtualExtensionRangeListObject(ApiModel):
    #: ID of the virtual extension range.
    id: Optional[str] = None
    #: Name of the virtual extension range. This is a unique name for the virtual extension range.
    name: Optional[str] = None
    ...
    level: Optional[GetVirtualExtensionRangeListObjectLevel] = None
...
class PutVirtualExtensionRangeObjectAction(str, Enum):
...
class ValidateVirtualExtensionRangeResponseObjectStatus(str, Enum):
...
class VirtualExtensionRangeValidationStatusEnum(str, Enum):
    #: Validation is successful.
    valid = 'VALID'
...
class VirtualExtensionRangeValidationStatusObject(ApiModel):
    ...
    status: Optional[VirtualExtensionRangeValidationStatusEnum] = None


class ValidateVirtualExtensionRangeResponseObject(ApiModel):
    #: Virtual extension range validation status.
    status: Optional[ValidateVirtualExtensionRangeResponseObjectStatus] = None
...
class BetaFeaturesVirtualExtensionsApi(ApiChild, base='/telephony/config'):
    ...
    def get_a_list_of_a_virtual_extension_range(self, order: str = None, name: str = None, prefix: str = None,
        ...
        return self.session.follow_pagination(url=url, model=GetVirtualExtensionRangeListObject, item_key='virtualExtensionRanges', params=params)

    def create_a_virtual_extension_range(self, name: str, prefix: str, patterns: list[str] = None,
    ...
    def validate_the_prefix_and_extension_pattern_for_a_virtual_extension_range(self, location_id: str = None,
                                                                                name: str = None, prefix: str = None,
                                                                                patterns: list[str] = None,
                                                                                range_id: str = None,
                                                                                org_id: str = None) -> ValidateVirtualExtensionRangeResponseObject:
        """
    ...
    def get_details_of_a_virtual_extension_range(self, extension_range_id: str,
                                                 org_id: str = None) -> GetVirtualExtensionRangeDetailsObject:
        """
        ...
        r = GetVirtualExtensionRangeDetailsObject.model_validate(data)
        return r
    ...
    def modify_virtual_extension_range(self, extension_range_id: str, name: str = None, prefix: str = None,
        ...
        :type action: PutVirtualExtensionRangeObjectAction
        :param org_id: Unique identifier for the organization.
        :type org_id: str
        :rtype: None
        """
    ...
    def read_the_list_of_virtual_extensions(self, order: str = None, extension: str = None, phone_number: str = None,
        ...
        return self.session.follow_pagination(url=url, model=GetVirtualExtensionObject, item_key='virtualExtensions', params=params)
    ...
    def validate_an_external_phone_number(self, phone_numbers: list[str], org_id: str = None) -> str:
        """
        ...
        :param phone_numbers: List of external phone numbers to be validated. External phone number in E.164 format.
    ...
    def get_virtual_extension_settings(self, org_id: str = None) -> GetVirtualExtensionSettingsObjectMode:
        """
    ...
    def modify_virtual_extension_settings(self, mode: GetVirtualExtensionSettingsObjectMode, org_id: str = None):
        ...
        extension.
        :type mode: GetVirtualExtensionSettingsObjectMode
        :param org_id: Unique identifier for the organization.
        :type org_id: str
        :rtype: None
        """
