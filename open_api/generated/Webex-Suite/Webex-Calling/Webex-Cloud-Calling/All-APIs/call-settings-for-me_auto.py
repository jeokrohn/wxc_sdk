...
__all__ = ['AddressObject', 'AgentACDStateType', 'Assistant', 'AvailableAssistant', 'BargeInInfo',
           ...
           'CallQueueSettingsGetResponseObject', 'CallSettingsForMe13Api', 'CallerIdSettingsGet', 'CallerIdType',
...
class MonitoredElementItem(ApiModel):
    ...
    #: The list of phone numbers of the monitored person, place, virtual line or speed dial.
...
class VoicemailInfoTransferToNumber(ApiModel):
    #: If `true`, state of giving caller option to transfer to destination when pressing zero (0) is enabled.
    enabled: Optional[bool] = None
...
class CallSettingsForMe13Api(ApiChild, base='telephony/config/people/me'):
    """
    Call Settings for Me (1/3)
    ...
    def modify_my_voicemail_settings(self, notifications: VoicemailInfoNotifications,
                                     transfer_to_number: VoicemailInfoTransferToNumber, enabled: bool = None,
                                     send_all_calls: VoicemailInfoSendAllCalls = None,
                                     send_busy_calls: VoicemailPutSendBusyCalls = None,
                                     send_unanswered_calls: VoicemailPutSendUnansweredCalls = None,
                                     email_copy_of_message: VoicemailInfoEmailCopyOfMessage = None,
