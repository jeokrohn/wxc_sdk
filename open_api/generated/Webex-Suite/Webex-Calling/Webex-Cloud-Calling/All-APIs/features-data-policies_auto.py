...
__all__ = ['CustomerDataPoliciesGetResponseObject', 'DataPolicyRegion', 'FeaturesDataPoliciesApi',
           'LocationDataPoliciesGetResponseObject']


class CustomerDataPoliciesGetResponseObject(ApiModel):
...
class LocationDataPoliciesGetResponseObject(ApiModel):
...
class FeaturesDataPoliciesApi(ApiChild, base='telephony/config'):
    """
    ...
    def read_data_policy_settings(self, org_id: str = None) -> CustomerDataPoliciesGetResponseObject:
        """
        ...
        :type org_id: str
        :rtype: :class:`CustomerDataPoliciesGetResponseObject`
        """
        ...
        r = CustomerDataPoliciesGetResponseObject.model_validate(data)
        return r
    ...
    def get_location_data_policy_settings(self, location_id: str,
                                          org_id: str = None) -> LocationDataPoliciesGetResponseObject:
        """
        ...
        :type org_id: str
        :rtype: :class:`LocationDataPoliciesGetResponseObject`
        """
        params: dict[str, Any] = dict()
        if org_id is not None:
            params['orgId'] = org_id
        ...
        data = super().get(url, params=params)
        r = LocationDataPoliciesGetResponseObject.model_validate(data)
        return r

    def modify_location_data_policy_settings(self, location_id: str, location_data_region: str = None,
                                             use_org_data_region_enabled: bool = None, org_id: str = None) -> None:
        """
