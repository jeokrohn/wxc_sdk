...
__all__ = ['Call', 'CallControlsMembersMeApi', 'CallPersonalityEnum', 'CallStateEnum', 'CallTypeEnum', 'DialResponse',
...
class CallControlsMembersMeApi(ApiChild, base='telephony/calls/members/me'):
    """
    ...
    **Notes:**
    ...
    def dial(self, destination: str, endpoint_id: str = None, single_number_reach_phone_number: str = None,
             line_owner_id: str = None) -> DialResponse:
        """
        Dial
