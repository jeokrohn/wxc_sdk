...
__all__ = ['FeaturesVirtualExtensionsApi', 'GetVirtualExtensionObject', 'GetVirtualExtensionObjectLevel',
           'GetVirtualExtensionRangeDetailsObject', 'GetVirtualExtensionRangeListObject',
           'GetVirtualExtensionSettingsObjectMode', 'PutVirtualExtensionRangeObjectAction',
           'ValidateVirtualExtensionRangeResponseObject', 'ValidateVirtualExtensionRangeResponseObjectStatus',
           'VirtualExtensionRangeValidationStatusEnum', 'VirtualExtensionRangeValidationStatusObject']
...
class FeaturesVirtualExtensionsApi(ApiChild, base='telephony/config'):
    """
