...
__all__ = ['APIDomainManagementApi', 'ClaimDomain', 'DomainVerification', 'DomainVerificationToken',
...
class APIDomainManagementApi(ApiChild, base='identity/organizations'):
    """
    ...
    def claim_domain(self, org_id: str, data: list[PostDomainVerificationToken] = None,
                     force_domain_claim: bool = None, claim_domain_only: bool = None) -> builtins.list[ClaimDomain]:
        """
        Claim Domain
        ...
        **Administrator Roles:**
        ...
        if data is not None:
            body['data'] = TypeAdapter(list[PostDomainVerificationToken]).dump_python(data, mode='json', by_alias=True, exclude_none=True)
        ...
        r = TypeAdapter(list[ClaimDomain]).validate_python(data['data'])
        return r
    ...
    def verify_domain(self, org_id: str, domain: str, claim_domain: bool = None,
                      reserve_domain: bool = None) -> DomainVerification:
        """
        Verify Domain
