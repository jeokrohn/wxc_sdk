...
class CallsApi(ApiChild, base='telephony/calls'):
    ...
    **Notes:**
    ...
    def list_calls(self, line_owner_id: str = None) -> list[TelephonyCall]:
        """
        List Calls
    ...
    def barge_in(self, target: str, endpoint_id: str = None, line_owner_id: str = None) -> CallInfo:
        """
        Barge In
    ...
    def dial(self, destination: str, endpoint_id: str = None, line_owner_id: str = None) -> CallInfo:
        """
        Dial
    ...
    def pause_recording(self, call_id: str = None, line_owner_id: str = None):
        """
        Pause Recording
    ...
    def pickup(self, target: str = None, endpoint_id: str = None, line_owner_id: str = None) -> CallInfo:
        """
        Pickup
    ...
    def reject(self, call_id: str, action: RejectAction = None, line_owner_id: str = None):
        """
        Reject
    ...
    def resume_recording(self, call_id: str = None, line_owner_id: str = None):
        """
        Resume Recording
    ...
    def retrieve(self, destination: str = None, endpoint_id: str = None, line_owner_id: str = None) -> CallInfo:
        """
        Retrieve
    ...
    def start_recording(self, call_id: str = None, line_owner_id: str = None):
        """
        Start Recording
    ...
    def stop_recording(self, call_id: str = None, line_owner_id: str = None):
        """
        Stop Recording
    ...
    def transmit_dtmf(self, call_id: str = None, dtmf: str = None, line_owner_id: str = None):
        """
        Transmit DTMF
