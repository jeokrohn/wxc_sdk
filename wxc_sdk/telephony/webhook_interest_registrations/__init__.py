...
class WebhookInterestRegistration(ApiModel):
...
class WebhookInterestRegistrationsApi(ApiChild, base='telephony/webhookInterestRegistrations'):
    ...
    **Notes:**
    ...
    # noinspection method-overriding
    def get(self) -> WebhookInterestRegistration:  # type: ignore[override]
        """
    ...
    def create(self, interests: list[Interest], duration: int = None) -> None:
        """
