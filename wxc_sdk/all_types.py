...
__all__ = ['AcdCustomization', 'Action', 'ActivationCodeResponse', 'AdaptiveCard', 'AdaptiveCardAction',
           ...
           'DistinctiveRing', 'EmergencyDestination', 'EnabledAndNumberOfDays', 'Event', 'EventData', 'EventResource',
           ...
           'HistoryType', 'HolidayService', 'HostedFeatureDestination', 'HostedUserDestination', 'HuntGroup',
           'IdAndName', 'IdOnly', 'IncomingPermissions', 'InterceptAnnouncements', 'InterceptNumber',
           ...
           'JobExecutionStatus', 'License', 'LineKeyLabelSelection', 'LineKeyLedPattern', 'ListRoomsResponse',
