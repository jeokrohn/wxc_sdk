...
__all__ = ['AcdCustomization', 'Action', 'ActivationCodeResponse', 'ActivationState', 'AdaptiveCard',
           ...
           'DeviceCustomization', 'DeviceCustomizations', 'DeviceLayout', 'DeviceList', 'DeviceManagedBy',
           'DeviceManufacturer', 'DeviceMember', 'DeviceMembersResponse', 'DeviceOwner', 'DevicePlatform',
           'DeviceSettings', 'DeviceSettingsConfiguration', 'DeviceStatus', 'DeviceType', 'DialPatternStatus',
           'DialPatternValidate', 'DialPatternValidationResult', 'DialPlan', 'DialResponse', 'Dialing',
           'DifferentHoursDaily', 'DigitPattern', 'DigitPatterns', 'DirectoryMethod', 'DisplayCallqueueAgentSoftkey',
           ...
           'EnhancedMulticast', 'EnterpriseUser', 'EntryAndExitTone', 'ErrorMessageObject', 'ErrorObject', 'Event',
           'EventData', 'EventResource', 'EventType', 'ExceptionType', 'ExecAssistantType', 'ExecuteCommandResponse',
           'ExpirePasscode', 'ExternalCallerIdNamePolicy', 'ExternalTransfer', 'FailedAttempts',
           'FeatureAccessCodeDestination', 'FeatureReference', 'FeatureSelector', 'FeatureType', 'Floor',
           'ForcedForward', 'ForwardCallsTo', 'ForwardFromSelection', 'ForwardOperatingModes',
