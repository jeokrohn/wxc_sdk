...
from wxc_sdk.person_settings.call_recording import CallRecordingAccessSettings, CallRecordingAnnouncement, \
    CallRecordingAnnouncements, CallRecordingSetting, Notification, NotificationRepeat, NotificationType, \
    PostCallRecordingSettings, Record, StartStopAnnouncement
...
__all__ = ['AcdCustomization', 'Action', 'ActionToBePerformed', 'ActionToBePerformedAction', 'ActivationCodeResponse',
           ...
           'BlockPreviousPasscodes', 'BlockRepeatedDigits', 'BlockingDisableCalling', 'BlockingUnlessForced',
           'BluetoothMode', 'BluetoothSetting', 'BreakoutSession', 'BulkErrorResponse', 'BulkMethod', 'BulkOperation',
           'BulkResponse', 'BulkResponseOperation', 'BusinessContinuity', 'CCExtensions', 'CCSnippet', 'CDR',
           'CDRCallType', 'CDRClientType', 'CDRDirection', 'CDROriginalReason', 'CDRRedirectReason',
           'CDRRelatedReason', 'CDRUserType', 'CPActionType', 'CQHolidaySchedule', 'CQRoutingType', 'Calendar',
           'CalendarType', 'CallActivity', 'CallActivityAnnouncement', 'CallActivityParticipant',
           'CallActivityStream', 'CallBackSelected', 'CallBlockNumber', 'CallBounce', 'CallBridgeSetting',
           'CallForwardExpandedSoftKey', 'CallForwarding', 'CallForwardingAlways', 'CallForwardingCommon',
           'CallForwardingNoAnswer', 'CallForwardingNumber', 'CallForwardingPerson', 'CallHistoryMethod',
           'CallHistoryRecord', 'CallInNumber', 'CallInNumbers', 'CallInfo', 'CallInterceptDetails',
           'CallInterceptDetailsPermission', 'CallNotify', 'CallNotifyCriteria', 'CallPark', 'CallParkExtension',
           'CallParkRecall', 'CallParkSettings', 'CallPickup', 'CallQueue', 'CallQueueAgent', 'CallQueueAgentDetail',
           'CallQueueAgentQueue', 'CallQueueCallPolicies', 'CallQueueSettings', 'CallRecordingAccessSettings',
           ...
           'LocationAssignedNumber', 'LocationCallCaptions', 'LocationCallNotification',
           ...
           'LocationNameAddress', 'LocationVoiceMailSettings', 'LoggingLevel', 'LoginResponse', 'MACState',
           'MACStatus', 'MACValidationResponse', 'MSTeamsSettings', 'MaintenanceMode', 'ManagedBy', 'ManagedGroup',
           'ManagedOrg', 'ManagerObject', 'MeCallCenterSettings', 'MeCallQueue', 'MeCallerIdSettings', 'MeDevice',
           ...
           'PlaylistUsageType', 'Policy', 'PostCallRecordingSettings', 'PreferredAnswerEndpoint',
           ...
           'SettingsGroup', 'SettingsObject', 'SettingsType', 'ShowWhen', 'SimRing', 'SimRingCriteria',
           'SimRingNumber', 'SimultaneousInterpretation', 'SingleNumberReach', 'SingleNumberReachNumber',
           ...
           'TelephonyType', 'TemporaryDirectDownloadLink', 'TestCallRoutingResult', 'Tokens', 'TrackingCode',
