...
__all__ = ['BetaLocationCallSettingsWithServiceNumberApi', 'LocationAvailableNumberObject',
           'LocationECBNAvailableNumberObject', 'LocationECBNAvailableNumberObjectOwner',
           'LocationECBNAvailableNumberObjectOwnerType', 'LocationObject', 'NumberObject', 'NumberObjectOwner',
           'NumberOwnerType', 'STATE', 'TelephonyType', 'WebexGoAvailableNumberObject']
...
class NumberOwnerType(str, Enum):
    ...
    #: PSTN phone number's owner is voice messaging.
...
class NumberObjectOwner(ApiModel):
    ...
    #: Display name of the PSTN phone number's owner. Only returned when the owner type is a Feature.
    #: example: Mark Zand
...
class LocationECBNAvailableNumberObjectOwnerType(str, Enum):
...
class LocationECBNAvailableNumberObjectOwner(ApiModel):
    ...
    #: example: PEOPLE
    type: Optional[LocationECBNAvailableNumberObjectOwnerType] = None
...
class BetaLocationCallSettingsWithServiceNumberApi(ApiChild, base='telephony/config/locations'):
    """
    Beta Location Call Settings with Service Number
