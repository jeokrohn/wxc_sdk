...
__auto__ = ['BetaFeaturesPeopleWithOptimizationApi', 'CreateAPersonPhoneNumbers', 'CreateAPersonPhoneNumbersType',
            'Person', 'PersonAddresses', 'PersonInvitePending', 'PersonPhoneNumbers', 'PersonPhoneNumbersType',
...
class BetaFeaturesPeopleWithOptimizationApi(ApiChild, base='people'):
    """
    Beta Features:  People With Optimization
