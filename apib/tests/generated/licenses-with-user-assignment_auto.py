...
class SiteUrlsRequest(ApiModel):
    ...
    #: example: attendee
    accountType: Optional[SiteUrlsRequestAccountType] = None
    #: Operation type. The default operation is `add` if no operation is specified.
    #: example: add
    operation: Optional[LicenseRequestOperation] = None
...
class PatchUserLicenses(ApiModel):
    ...
    siteUrls: Optional[list[SiteUrlsRequest]] = None
...
class SiteResponse(ApiModel):
    ...
    #: example: attendee
    accountType: Optional[SiteResponseAccountType] = None
...
class UserLicensesResponse(ApiModel):
    ...
    siteUrls: Optional[list[SiteResponse]] = None
    ...
    pendingLicenses: Optional[list[str]] = None
    ...
    pendingSiteUrls: Optional[list[SiteResponse]] = None
