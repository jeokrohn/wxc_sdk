...
__all__ = ['BetaWorkspacesWithWebexCallingLicenseSubscriptionApi', 'CapabilityMap', 'SupportAndConfiguredInfo',
           ...
           'WorkspaceType1', 'WorkspaceUpdateRequestType']
...
class BetaWorkspacesWithWebexCallingLicenseSubscriptionApi(ApiChild, base='workspaces'):
    """
    Beta Workspaces with Webex Calling License Subscription
