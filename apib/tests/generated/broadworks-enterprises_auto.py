...
__auto__ = ['EnterpriseListResponse', 'EnterpriseListResponseBroadworksDirectorySync', 'EnterpriseListResponseBroadworksDirectorySyncDirectorySyncStatus', 'EnterpriseListResponseBroadworksDirectorySyncDirectorySyncStatusErrors', 'TriggerUserDirectorySyncResponse', 'TriggerUserDirectorySyncResponseStatus', 'TriggerUserDirectorySyncResponseUserResponse', 'UpdateDirectorySyncResponse', 'UpdateDirectorySyncResponseDirectorySyncStatus']
...
class UpdateDirectorySyncResponse(ApiModel):
    ...
    enableDirSync: Optional[bool] = None
    #: Directory sync status
    directorySyncStatus: Optional[UpdateDirectorySyncResponseDirectorySyncStatus] = None
