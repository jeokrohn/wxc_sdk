...
__auto__ = ['GetPersonOrWorkspaceDetailsObject', 'GetPersonOrWorkspaceDetailsObjectDepartment', 'PutPersonOrWorkspaceDetailsObject', 'PutPersonOrWorkspaceDetailsObjectDepartment']
