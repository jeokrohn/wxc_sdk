...
__auto__ = ['AnswerForCustomizedQuestion', 'BatchUpdateMeetingRegistrantsStatusStatusOpType', 'BreakoutSessionObject',
            ...
            'MeetingTrackingCodesObjectType', 'MeetingsWithAdmissionFromLobbyToBreakoutSessionApi',
            'OptionsForTrackingCodeObject', 'QueryRegistrantsOrderBy', 'QueryRegistrantsOrderType', 'QuestionObject',
            'QuestionObjectType', 'QuestionOptionObject', 'QuestionWithAnswersObject',
            'ReassignMeetingErrorDescriptionObject', 'ReassignMeetingResponseObject', 'Registrant',
            'RegistrantCreateResponse', 'RegistrantFormObject', 'RegistrantStatus', 'Registrants', 'Registration',
            'ScheduledMeetingObject', 'StandardRegistrationApproveRule', 'StandardRegistrationApproveRuleQuestion',
...
class MeetingsWithAdmissionFromLobbyToBreakoutSessionApi(ApiChild, base='meetings'):
    ...
    def join_a_meeting(self, meeting_id: str = None, meeting_number: str = None, web_link: str = None,
                       ...
                       expiration_minutes: int = None) -> JoinMeetingLinkObject:
        """
        Join a Meeting
