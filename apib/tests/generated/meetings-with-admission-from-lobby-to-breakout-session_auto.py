...
__auto__ = ['AnswerForCustomizedQuestion', 'BatchRegisterMeetingRegistrantsResponse',
            ...
            'GetBreakoutSessionObject', 'GetBreakoutSessionsObject',
            ...
            'StandardRegistrationApproveRuleQuestion', 'SurveyObject', 'SurveyResultObject', 'TemplateObject',
...
class ScheduledMeetingObject(ApiModel):
    ...
    #: option is enabled for the meeting. See
    #: https://help.webex.com/en-us/nmgmeff/Register-for-a-Meeting-in-Cisco-Webex-Meetings for details.    +
...
class UpdateMeetingObject(ApiModel):
    ...
    #: 10 minutes or longer than 24 hours. Refer to the [Webex
    ...
    #: than 10 minutes or longer than 24 hours. Refer to the [Webex
    #: Meetings](/docs/meetings#restrictions-on-updating-a-meeting) guide for more information about restrictions on
...
class CreateMeetingObject(ApiModel):
    ...
    #: Date and time for the start of meeting in any https://en.wikipedia.org/wiki/ISO_8601 compliant format. `start`
    #: cannot be before current date and time or after `end`. Duration between `start` and `end` cannot be shorter than
    #: 10 minutes or longer than 24 hours. Please note that when a meeting is being scheduled, `start` of the meeting
    #: will be accurate to minutes, not seconds or milliseconds. Therefore, if `start` is within the same minute as the
    #: current time, `start` will be adjusted to the upcoming minute; otherwise, `start` will be adjusted with seconds
    #: and milliseconds stripped off. For instance, if the current time is `2022-03-01T10:32:16.657+08:00`, `start` of
    #: `2022-03-01T10:32:28.076+08:00` or `2022-03-01T10:32:41+08:00` will be adjusted to `2022-03-01T10:33:00+08:00`,
    #: and `start` of `2022-03-01T11:32:28.076+08:00` or `2022-03-01T11:32:41+08:00` will be adjusted to
    #: `2022-03-01T11:32:00+08:00`. The default value for an ad-hoc meeting is 5 minutes after the current time and the
    #: user's input value will be ignored. An ad-hoc meeting can be started immediately even if the `start` is 5
    #: minutes after the current time.
    #: example: 2020-05-15T20:30:00-08:00
    start: Optional[datetime] = None
    #: Date and time for the end of meeting in any https://en.wikipedia.org/wiki/ISO_8601 compliant format. `end`
    #: cannot be before current date and time or before `start`. Duration between `start` and `end` cannot be shorter
    #: than 10 minutes or longer than 24 hours. Please note that when a meeting is being scheduled, `end` of the
    #: meeting will be accurate to minutes, not seconds or milliseconds. Therefore, `end` will be adjusted with seconds
    ...
    #: apply to a meeting when it's a recurring meeting with a recurrence field or no password, or the Join Before Host
    #: option is enabled for the meeting. See
    #: https://help.webex.com/en-us/nmgmeff/Register-for-a-Meeting-in-Cisco-Webex-Meetings for details. This parameter
    #: is ignored for an ad-hoc meeting.
...
class JoinMeetingObject(ApiModel):
    ...
    #: otherwise, it's generated for the user calling the API. `email` is required for a
