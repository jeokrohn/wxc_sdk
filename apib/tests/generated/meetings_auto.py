...
class PatchMeetingObject(ApiModel):
    #: Meeting title. The title can be a maximum of 128 characters long.
    #: example: John's Meeting
    title: Optional[str] = None
    #: Meeting agenda. The agenda can be a maximum of 1300 characters long. It can be specified `null` so that it
...
class MeetingsApi(ApiChild, base='meetings'):
    ...
    def join_a_meeting(self, meeting_id: str = None, meeting_number: str = None, web_link: str = None,
                       ...
                       expiration_minutes: int = None, registration_id: Union[str, datetime] = None,
