...
__auto__ = ['GetPhoneNumbersForAnOrganizationWithGivenCriteriasOwnerType',
            'GetPhoneNumbersForAnOrganizationWithGivenCriteriasResponse', 'NumberListGetObject',
            'NumberListGetObjectLocation', 'NumberListGetObjectOwner']
