...
__all__ = ['BetaFeaturesHuntGroupWithServiceNumberApi', 'HuntGroupCallForwardAvailableNumberObject',
           'HuntGroupCallForwardAvailableNumberObjectOwner', 'HuntGroupPrimaryAvailableNumberObject',
...
class BetaFeaturesHuntGroupWithServiceNumberApi(ApiChild, base='telephony/config/locations'):
    """
    Beta Features: Hunt Group with Service Number
    ...
    def get_hunt_group_primary_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        url = self.ep(f'{location_id}/huntGroups/availableNumbers')
    ...
    def get_hunt_group_alternate_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        if phone_number is not None:
            params['phoneNumber'] = ','.join(phone_number)
        url = self.ep(f'{location_id}/huntGroups/alternate/availableNumbers')
        return self.session.follow_pagination(url=url, model=HuntGroupPrimaryAvailableNumberObject, item_key='phoneNumbers', params=params)
    ...
    def get_hunt_group_call_forward_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        url = self.ep(f'{location_id}/huntGroups/callForwarding/availableNumbers')
