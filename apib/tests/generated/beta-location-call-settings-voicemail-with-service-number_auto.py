...
__all__ = ['BetaLocationCallSettingsVoicemailWithServiceNumberApi', 'STATE', 'TelephonyType',
...
class BetaLocationCallSettingsVoicemailWithServiceNumberApi(ApiChild, base='telephony/config/locations'):
    """
    Beta Location Call Settings Voicemail with Service Number
    
    Location Call Settings: Voicemail supports reading and writing of Webex Calling Location Voicemail settings for a
    ...
    def get_voicemail_group_fax_message_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        url = self.ep(f'{location_id}/voicemailGroups/faxMessage/availableNumbers')
    ...
    def get_voicemail_group_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        if phone_number is not None:
            params['phoneNumber'] = ','.join(phone_number)
        url = self.ep(f'{location_id}/voicemailGroups/availableNumbers')
        return self.session.follow_pagination(url=url, model=VoicePortalAvailableNumberObject, item_key='phoneNumbers', params=params)
    ...
    def get_voice_portal_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        if phone_number is not None:
            params['phoneNumber'] = ','.join(phone_number)
        url = self.ep(f'{location_id}/voicePortal/availableNumbers')
        return self.session.follow_pagination(url=url, model=VoicePortalAvailableNumberObject, item_key='phoneNumbers', params=params)
