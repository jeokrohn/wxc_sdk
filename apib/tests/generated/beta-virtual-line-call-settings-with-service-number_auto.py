...
__all__ = ['BetaVirtualLineCallSettingsWithServiceNumberApi', 'NumberOwnerType', 'STATE', 'TelephonyType',
           ...
           'VirtualLineECBNAvailableNumberObjectOwnerType', 'VirtualLineFaxMessageAvailableNumberObject']
...
class BetaVirtualLineCallSettingsWithServiceNumberApi(ApiChild, base='telephony/config/virtualLines'):
    """
    Beta Virtual Line Call Settings with Service Number
    
    A virtual line allows administrators to configure multiple lines for webex calling users. Virtual lines settings
    supports reading and writing of webex calling virtual lines and its configuration for a specific organization.
    ...
    def get_virtual_line_call_forward_available_phone_numbers(self, virtual_line_id: str,
        ...
        List service and standard numbers that are available to be assigned as a virtual line's call forward number.
        These numbers are associated with the location of the virtual line specified in the request URL, can be active
    ...
    def get_virtual_line_call_intercept_available_phone_numbers(self, virtual_line_id: str,
        ...
        List service and standard numbers that are available to be assigned as a virtual line's call intercept number.
        These numbers are associated with the location of the virtual line specified in the request URL, can be active
        or inactive, and are assigned to an owning entity.
