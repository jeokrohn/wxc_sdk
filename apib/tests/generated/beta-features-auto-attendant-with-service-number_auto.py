...
__all__ = ['AutoAttendantCallForwardAvailableNumberObject', 'AutoAttendantCallForwardAvailableNumberObjectOwner',
           'AutoAttendantPrimaryAvailableNumberObject', 'BetaFeaturesAutoAttendantWithServiceNumberApi',
...
class BetaFeaturesAutoAttendantWithServiceNumberApi(ApiChild, base='telephony/config/locations'):
    """
    Beta Features: Auto Attendant with Service Number
    
    Features: Auto Attendant supports reading and writing of Webex Calling Auto Attendant settings for a specific
    organization.
    ...
    def get_auto_attendant_primary_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        url = self.ep(f'{location_id}/autoAttendants/availableNumbers')
    ...
    def get_auto_attendant_alternate_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        if phone_number is not None:
            params['phoneNumber'] = ','.join(phone_number)
        url = self.ep(f'{location_id}/autoAttendants/alternate/availableNumbers')
        return self.session.follow_pagination(url=url, model=AutoAttendantPrimaryAvailableNumberObject, item_key='phoneNumbers', params=params)
    ...
    def get_auto_attendant_call_forward_available_phone_numbers(self, location_id: str, phone_number: list[str] = None,
        ...
        url = self.ep(f'{location_id}/autoAttendants/callForwarding/availableNumbers')
