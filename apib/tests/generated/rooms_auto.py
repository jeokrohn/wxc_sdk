...
__auto__ = ['Room', 'RoomCollectionResponse', 'RoomMeetingDetails', 'RoomType']
...
class Room(ApiModel):
    ...
    isAnnouncementOnly: Optional[bool] = None
    ...
    madePublic: Optional[datetime] = None
...
class RoomMeetingDetails(ApiModel):
    ...
    callInTollFreeNumber: Optional[str] = None
    #: The toll (local) PSTN number for the room.
    #: example: +1-408-525-6800
    callInTollNumber: Optional[str] = None
