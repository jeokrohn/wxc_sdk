...
class AudioAnnouncementFileFeatureGetObject(ApiModel):
    ...
    #: example: WAV
    mediaFileType: Optional[AudioAnnouncementFileFeatureGetObjectMediaFileType] = None
...
class CallForwardSettingsGet(ApiModel):
    ...
    callForwarding: Optional[CallForwardSettingsGetCallForwarding] = None
...
class CallQueueHolidaySchedulesObject(ApiModel):
    ...
    #: example: LOCATION
    scheduleLevel: Optional[CallQueueHolidaySchedulesObjectScheduleLevel] = None
...
class CallQueueQueueSettingsGetObjectOverflow(ApiModel):
    ...
    audioAnnouncementFiles: Optional[list[AnnouncementAudioFileGet]] = None
...
class CallQueueQueueSettingsGetObjectWaitMessage(ApiModel):
    ...
    #: example: POSITION
    waitMode: Optional[CallQueueQueueSettingsGetObjectWaitMessageWaitMode] = None
...
class CallQueueQueueSettingsGetObjectMohMessage(ApiModel):
    normalSource: Optional[CallQueueQueueSettingsGetObjectMohMessageNormalSource] = None
    alternateSource: Optional[CallQueueQueueSettingsGetObjectMohMessageNormalSource] = None
...
class CallQueueQueueSettingsGetObject(ApiModel):
    ...
    #: example: True
    callOfferToneEnabled: Optional[bool] = None
    ...
    welcomeMessage: Optional[CallQueueQueueSettingsGetObjectWelcomeMessage] = None
    ...
    waitMessage: Optional[CallQueueQueueSettingsGetObjectWaitMessage] = None
    ...
    comfortMessage: Optional[CallQueueQueueSettingsGetObjectComfortMessage] = None
    ...
    comfortMessageBypass: Optional[CallQueueQueueSettingsGetObjectComfortMessageBypass] = None
    #: Play music after the comforting message in a repetitive loop.
    mohMessage: Optional[CallQueueQueueSettingsGetObjectMohMessage] = None
    ...
    whisperMessage: Optional[CallQueueQueueSettingsGetObjectMohMessageNormalSource] = None
...
class CreateForwardingRuleObjectCallsFromCustomNumbers(ApiModel):
    ...
    privateNumberEnabled: Optional[bool] = None
    #: Match if caller ID is unavailable.
    unavailableNumberEnabled: Optional[bool] = None
...
class CreateForwardingRuleObjectCallsFrom(ApiModel):
    ...
    customNumbers: Optional[CreateForwardingRuleObjectCallsFromCustomNumbers] = None
...
class CreateForwardingRuleObject(ApiModel):
    ...
    forwardTo: Optional[CreateForwardingRuleObjectForwardTo] = None
    #: Settings related to the rule matching based on incoming caller ID.
    callsFrom: Optional[CreateForwardingRuleObjectCallsFrom] = None
    #: Settings related to the rule matching based on the destination number.
    callsTo: Optional[CreateForwardingRuleObjectCallsTo] = None
...
class GetAnnouncementFileInfo(ApiModel):
    ...
    #: example: WAV
    mediaFileType: Optional[MediaType] = None
...
class GetCallQueueForcedForwardObject(ApiModel):
    ...
    #: example: True
    forcedForwardEnabled: Optional[bool] = None
    ...
    #: example: True
    playAnnouncementBeforeEnabled: Optional[bool] = None
    #: Specifies what type of announcement to be played.
    #: example: DEFAULT
    audioMessageSelection: Optional[CallQueueQueueSettingsGetObjectOverflowGreeting] = None
    #: List of Announcement Audio Files when `audioMessageSelection` is `CUSTOM`.
    audioFiles: Optional[list[AudioAnnouncementFileFeatureGetObject]] = None
...
class GetCallQueueHolidayObject(ApiModel):
    ...
    #: example: True
    holidayServiceEnabled: Optional[bool] = None
    ...
    holidaySchedules: Optional[list[CallQueueHolidaySchedulesObject]] = None
...
class GetCallQueueNightServiceObject(ApiModel):
    ...
    #: example: True
    nightServiceEnabled: Optional[bool] = None
    #: Specifies call processing action type.
    #: example: TRANSFER
    action: Optional[GetCallQueueHolidayObjectAction] = None
    #: Call gets transferred to this number when action is set to `TRANSFER`. This can also be an extension.
    #: example: 1234
    transferPhoneNumber: Optional[datetime] = None
    #: Specifies if an announcement plays to callers before applying the action.
    #: example: True
    playAnnouncementBeforeEnabled: Optional[bool] = None
    #: Specifies the type of announcements to played.
    #: example: NORMAL
    announcementMode: Optional[GetCallQueueNightServiceObjectAnnouncementMode] = None
    ...
    businessHoursName: Optional[str] = None
    #: Specifies whether the above mentioned schedule is org or location specific. (Must be from `businessHourSchedules` list).
    #: example: ORGANIZATION
    businessHoursLevel: Optional[CallQueueHolidaySchedulesObjectScheduleLevel] = None
    #: Lists the pre-configured business hour schedules.
    businessHourSchedules: Optional[list[CallQueueHolidaySchedulesObject]] = None
    #: Force night service regardless of business hour schedule.
    #: example: True
    forceNightServiceEnabled: Optional[bool] = None
    #: Specifies what type of announcement to be played when `announcementMode` is `MANUAL`.
    #: example: DEFAULT
    manualAudioMessageSelection: Optional[CallQueueQueueSettingsGetObjectOverflowGreeting] = None
    #: List Of Audio Files.
    manualAudioFiles: Optional[list[AudioAnnouncementFileFeatureGetObject]] = None
...
class GetCallQueueObject(ApiModel):
    ...
    callPolicies: Optional[GetCallQueueCallPolicyObject] = None
    #: Overall call queue settings.
    queueSettings: Optional[CallQueueQueueSettingsGetObject] = None
...
class ModifyCallForwardingObject(ApiModel):
    #: Settings related to `Always`, `Busy`, and `No Answer` call forwarding.
    callForwarding: Optional[ModifyCallForwardingObjectCallForwarding] = None
