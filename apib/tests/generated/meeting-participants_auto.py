...
__auto__ = ['AdmitParticipantsObject', 'Device', 'DeviceAudioType', 'DeviceCallType', 'InProgressDevice', 'InProgressParticipant', 'InProgressParticipantState', 'Participant', 'ParticipantID', 'ParticipantState', 'ParticipantVideo']
...
class Device(ApiModel):
    ...
    #: example: pstn
    audioType: Optional[DeviceAudioType] = None
    ...
    #: example: 60.0
    durationSecond: Optional[int] = None
    #: The PSTN call type in which the device joined the meeting.
    #: example: callIn
    callType: Optional[DeviceCallType] = None
...
class Participant(ApiModel):
    ...
    spaceModerator: Optional[bool] = None
    ...
    breakoutSessionId: Optional[str] = None
