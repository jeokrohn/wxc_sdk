...
__all__ = ['BetaFeaturesHuntGroupWithModeManagementApi', 'CallForwardRulesGet', 'CallForwardRulesSet',
           ...
           'CallForwardSettingsGetCallForwardingOperatingModesExceptionType', 'ModesGet', 'ModesGetForwardTo',
...
class BetaFeaturesHuntGroupWithModeManagementApi(ApiChild, base='telephony/config/locations'):
    """
    Beta Features: Hunt Group with Mode Management
    
    Features: The Hunt Group feature allows for both reading and writing of Webex Calling Hunt Group settings for a
    ...
    def get_call_forwarding_settings_for_a_hunt_group(self, location_id: str, hunt_group_id: str,
        ...
        if org_id is not None:
            params['orgId'] = org_id
        url = self.ep(f'{location_id}/huntGroups/{hunt_group_id}/callForwarding')
    ...
    def switch_mode_for_call_forwarding_settings_for_a_hunt_group(self, location_id: str, hunt_group_id: str,
        ...
        if org_id is not None:
            params['orgId'] = org_id
        url = self.ep(f'{location_id}/huntGroups/{hunt_group_id}/callForwarding/actions/switchMode/invoke')
