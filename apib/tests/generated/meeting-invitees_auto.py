...
class UpdateInviteeObject(ApiModel):
    ...
    #: the email has been associated with an existing Webex account, the display name associated with the Webex account
    #: will be used; otherwise, the `email` will be used as `displayName`. In a Webex site, if `displayName` is
    ...
    #: associated with the Webex account; otherwise, `displayName` shown in the meeting will be the `displayName` which
    #: is specified by the invitee who does not have a Webex account.
    #: example: John Andersen
    display_name: Optional[str] = None
    #: Whether or not the invitee is a designated alternate host for the meeting. See https://help.webex.com/b5z6he/
    #: for more details.
...
class CreateInviteeObject(ApiModel):
    ...
    #: doesn't apply to an ended or ongoing meeting instance. The meeting ID of a scheduled
    #: https://help.webex.com/en-us/article/nul0wut/Webex-Personal-Rooms-in-Webex-Meetings meeting is not supported for
    #: this API.
...
class GetInviteeObject(ApiModel):
    ...
    #: example: John Andersen
    display_name: Optional[str] = None
    #: Whether or not invitee is a designated alternate host for the meeting. See https://help.webex.com/b5z6he/ for
    #: more details.
    co_host: Optional[bool] = None
